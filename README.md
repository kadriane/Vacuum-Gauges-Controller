...
The main aims of this project were to design and prototype a new controller, which replaces out-of-date and obsoleted controllers (the TPG300 and the VGC1000), still in use at CERN.
...
The practical part of this graduate project has been conducted from September 2017 up to September 2018 at CERN. Aims of this thesis were successfully fulfilled and the new controller has been physically made. 
...
The motherboard is a four-layers PCB, where two layers are power supply layers (ground and +3.3VDC, placed on two internal layers of the PCB), and the next two are signal layers (placed on external layers of the PCB).
...
The front panel design of the prototype has been designed in AutoCAD 2017. The front panel has been made with the use of a CNC milling machine.
...
More detailed photos of the prototype can be found in the attachments of this [master thesis](./MasterThesis_Rev20_0__24_09_18_Final.pdf).
...
The firmware implementation for the main STM32 microcontroller has been written in **`C`** in **`Atolic TrueStudio`** IDE.

The control console application has been written in **`C++11`** in **`Visual Studio Community 2017`** IDE.
...
More details about software can be found in the chapter 6 of this [master thesis](./MasterThesis_Rev20_0__24_09_18_Final.pdf).

### GUI templates (selected)
The Graphical User Interface (GUI) effects are generated by using designed GUI templates (stored as standard image formats, and loaded to the external NOR and SDRAM memories), and LCD-TFT internal controller of the STM32 and its two display layers.

More details about GUI can be found in the chapter 6.4 of the [master thesis](./MasterThesis_Rev20_0__24_09_18_Final.pdf).
